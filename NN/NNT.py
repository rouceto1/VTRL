...
parser = argparse.ArgumentParser(description='EXAMPLE: --in_model_path ./results_siam/model.pt --data_path ../nordland_rectified/ --d0 fall --d1 winter --dsp ../nordland_rectified/orb_orb_su_w_PRE_FILTER_ENTR.csv --omodel ./results_siam/model1.pt')
