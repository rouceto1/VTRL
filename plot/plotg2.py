...
import numpy as np
file_list=['../results/nPNN03w2.srt','../results/nFMNN03w2.srt','../results/nPFM03.srt']
names  = [ "Pure NN spring-winter $e(03,w_3)$","NN+FM spring-winter $e(03,w_3)$","Pure FM spring-winter $e(03,w_3)$"]
