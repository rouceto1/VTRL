...
def evaluate_to_file(out_path, _evaluation_prefix, _evaluation_paths, _weights_file, file_list=None,
                     _estimates_out=None,
                     _cache2=None, conf=None):
    images = 150
    ...
    out = [evaluate(out_path, _weights_file, _evaluation_prefix=_evaluation_prefix,
